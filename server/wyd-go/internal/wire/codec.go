...
//
// O TMScene 7.48 so exibe o texto se ele comeca com '^' (mensagens sem
// prefixo sao descartadas em silencio) e consome '!#' como sincronismo de
// data (DaySync). Por isso o caret e adicionado aqui, exceto para payload
// de protocolo.
