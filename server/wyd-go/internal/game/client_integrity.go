...
func (w *World) issueClientIntegrityChallenge(p *Player) {
	// Clients 7.30/7.26 nao implementam 0x1C1/0x2C2 do manifesto 7.48; o probe
	// falha na primeira resposta e derruba a sessao logo apos o enter-world.
	if p == nil || p.Session == nil || !p.InWorld || p.Char == nil ||
		p.ClientABI == wire.ABI730 ||
