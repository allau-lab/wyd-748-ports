...
// Qualidade/performance gráfica configurável no config.txt.
extern int g_nAnisotropic;
extern int g_bVsync;
...
// 1 = controles estilo LoL (RMB move, LMB ataca; windup/recovery).
extern int g_bLolControls;
// 1 = Wild Rift–style touch HUD (aarch64 default; [TOUCH_UI] in config).
extern int g_bTouchUi;
