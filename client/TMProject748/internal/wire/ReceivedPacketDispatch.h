...
namespace received_packet
{
    ...
    inline std::size_t ExpectedSize(unsigned int opcode)
    {
        ...
        // Packed wire sizes from WYD748 ABI (Basedef); avoid including Basedef here.
        case 0x364: return 328; // MSG_CreateMob
        case 0x363: return 352; // MSG_CreateMobTrade (Header+fields+Desc)
        default: return 0;
        }
    }
