...
#ifdef __linux__
	// Emissive mais alto: VS de skin no DXVK com LightVal baixo apaga cabeça/membros.
	m_materials.Emissive.r = 0.65f;
	m_materials.Emissive.g = 0.65f;
	m_materials.Emissive.b = 0.65f;
	// Diffuse.a left 0 by memset → VS oD0.a=0 + SRCALPHA punch-through on DXVK.
	m_materials.Diffuse.a = 1.0f;
	m_materials.Emissive.a = 1.0f;
	m_materials.Specular.a = 1.0f;
...
HRESULT TMSkinMesh::RestoreDeviceObjects()
{
	...
	{
		LOG_WRITELOG("TMSkinMesh: invalid bone ani index %d\r\n", m_nBoneAniIndex);
		return 0x80004005;
	}
