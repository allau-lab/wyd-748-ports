    ...
    m_vecCamPos{}
{
    ...
    // Keep the original 7.48 camera limit. Beyond this distance the current
    // two-chunk streamer has no terrain/object coverage and DXVK shows clear
    // fog/blue background instead of useful world data.
    m_fMaxCamLen = 20.0f;
}
